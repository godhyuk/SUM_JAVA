...
public class welcome {
	...
	public static void main(String[] args) {
		...
		System.out.println("2.장보기 상품 목록 보기 \t5.장바구니의 항목 수량 줄이기");
		...
		*/
		if (n<1 || n>9){
			...
			case 1:
				...
				//System.out.println("이름 "+ username + "엲락처" + usermobile);
	...
	*/
	...
	public static void menuCartClear(){
		...
		if(mCart.mCartCount == 0)
			...
			System.out.println("장바구니의 모든 항복을 삭제하겠습니까? Y | N");
			Scanner input = new Scanner(System.in);
	...
	/*public static void BookList(String[][] book) {
		...
		book[0][2] = "27000";
		book[0][3] = "송미영";
		book[0][4] = "단계별로 쇼핑물을 구현하며 배우는 JSP 웹 프로그래밍";
		book[0][5] = "IT전문서";
		book[0][6] = "2018/10/08";
	...
	public static void BookList(Book[]booklist) {
		...
		booklist[0].setDescription("단계별로 쇼핑물을 구현하며 배우는 JSP 웹 프로그래밍");
